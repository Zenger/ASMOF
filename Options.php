...
define('ADMIN_PATH', get_template_directory() . '/Options/smof-options-framework/admin/');
define('ADMIN_DIR',  get_template_directory_uri() . '/Options/smof-options-framework/admin/');
...
if (isset($_GET['page']) && $_GET['page'] == "asmof-theme-options")
{
...
class ASMOF
{
	...
	private static $dbASMOFOptions = array();

	public static function add_menu_page()
	{
		add_menu_page( "Theme Options", "Theme Options", "manage_options", "asmof-theme-options", array('Options', 'redirect_to_of'), get_template_directory_uri() . '/images/theme-options.png' );
	}
	...
	public static function get($option, $default = null) 
	{
		...
		if (is_array($saved)) 
		{
			...
			{
				return apply_filters( 'ASMOFOptions_get', $default );
			}
			else
			{
				return apply_filters( 'ASMOFOptions_get', $saved[$option] );
			}
		}
		else
		{
...
add_action('admin_menu', array("ASMOFOptions", "add_menu_page") );
